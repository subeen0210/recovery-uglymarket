...
<html>
  ...
  <footer>
    <div class="container">
      <div class="footer1">
        <div><span class="a-footer">利用規約</span>&emsp;&emsp;</div>
        <div><span class="a-footer">個人情報処理方針</span> &emsp;&emsp;</div>
        <div><span class="a-footer">電子金融取引約款</span>&emsp;&emsp;</div>
        <div><span class="a-footer">安全取引政策</span>&emsp;&emsp;</div>
      </div>
      <div class="footer2">
        <div class="footer3">
          アグリーマーケット株式会社 | 代表:キム·ヨンミン | 事業者登録番号:
          732-86-02604 | 通販業届出番号:2022-衿川-2280
        </div>
        <div class="footer3">
          本社:忠清南道天安市東南区大興路321、501 | 支店:
          ソウル特別市城北区花郎路13ギル59,518
        </div>
