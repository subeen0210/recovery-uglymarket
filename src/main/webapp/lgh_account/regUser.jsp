      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <button type="button" id="checkDuplicate" value="users">
              重複確認</button
            ><br />
        ...
        <div>
          <div>お名前</div>
          <div>姓<input name="userKanji_ln" /></div>
          <div>名<input name="userKanji_fn" /></div>
          <div>セイ<input name="userKata_ln" /></div>
          <div>メイ<input name="userKata_fn" /></div>
        </div>
        <div>
          <div>ニックネーム</div>
          <div>
        ...
        <div>
          ...
          <div>
            ...
            <br />
            郵便番号
            <input name="userAddrN" id="addrNum" readonly="readonly" /><br />
            都道府県
            <input
              name="userAddrP"
              id="addrPrefecture"
            ...
            /><br />
            市区町村
            <input name="userAddrC" id="addrCity" readonly="readonly" /><br />
