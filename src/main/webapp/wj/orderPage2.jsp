		...
		<div class="main-wrapper">
			<div class="detail-wrap">
				...
				<details class="demo-details-juqery-accordion">
					...
					<p>
						...
						<span id="order-addr-user"> <span class="span-set-position">${addr.a_name }<button
									class="custom-btn">수정</button></span><br />
						<br> <span>${addr.a_tel }</span><br>
						<br> <span>${addr.a_addr }${addr.a_addrDetail }
								(${addr.a_postcode })</span>
						</span><br />
						<br />
						<br> <span id="order-addr-times"> <span
							style="font-size: 15pt; font-weight: bold;">配送時間帯を設定</span><br>
			...
			<div class="detail-wrap">
				...
				<details class="demo-details-juqery-accordion">
					...
					<p
						style="position: relative; height: 0px; font-size: 15pt; font-weight: bold;">
						<span>판매농장</span><span class="order-delivery-status">무료배송</span>
					</p>
					<hr />
					<p id="items">
						<span id="getItems"> <span class="order-item-imgbox">
								<img class="img-set-size" src="홍련.PNG" />
						</span> <span class="order-item"> <span class="order-item-name">아이템
									제목아이템 제목아이템 제목아이템 제목아이템 제목아이템 제목아이템 제목아이템 제목아이템 제목아이템 제목</span><br>
								<span>(어글리)&ensp;못난이농장</span><br>
							<br> <span>가격 * 수량</span>
						</span>
						</span><br />
						<br>
						<br> <span id="totalPrice">総額&ensp;:&ensp;20000円</span>
					</p>
				</details>
			</div>
			<div class="set-btn">
